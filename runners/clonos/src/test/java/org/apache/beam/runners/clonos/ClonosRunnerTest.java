...
/** Test for {@link ClonosRunner}. */
public class ClonosRunnerTest {
  ...
  public static void main(String[] args) {
    ...
    options.setRunner(NotExecutingClonosRunner.class);
  ...
  private static class NotExecutingClonosRunner extends ClonosRunner {

    protected NotExecutingClonosRunner(FlinkPipelineOptions options) {
      // Stdout/Stderr is restored here
      super(options);
    }

    @SuppressWarnings("unused")
    public static NotExecutingClonosRunner fromOptions(PipelineOptions options) {
      return new NotExecutingClonosRunner(options.as(FlinkPipelineOptions.class));
    }
