...
import org.apache.beam.runners.clonos.translation.wrappers.streaming.DoFnOperator.MultiOutputOutputManagerFactory;
...
public class WindowDoFnOperatorTest {
  ...
  public void testRestore() throws Exception {
    ...
    Iterable<WindowedValue<KV<Long, Long>>> output =
        StreamRecordStripper.stripStreamRecordFromWindowedValue(testHarness.getOutput());
